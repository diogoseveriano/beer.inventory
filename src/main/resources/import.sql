...
insert into item (deprecated, brand, category_id, createddate, id, modifieddate, code, createdby, description, modifiedby, name, notes)
values (false, 'Weyerman', 1, now(), 1, now(), 'CEREAL_RM_PILS', 'script', '', 'script', 'MALTE PILSNER', '');
insert into item (deprecated, brand, category_id, createddate, id, modifieddate, code, createdby, description, modifiedby, name, notes)
values (false, 'Weyerman', 1, now(), 2, now(), 'CEREAL_RM_MELAD', 'script', '', 'script', 'MALTE MELADONIN', '');